...
int main()
{
	...
	// max supply 0.9
	string pwlh = " PWL (0n 0 2n 0 2.01n 0.9 4n 0.9)";
	string pwhl = " PWL(0n 0.9 2n 0.9 2.01n 0 4n 0)";
	...
	{ 
		...
		{
			measure << "\tmeas tran TP_LH_" << lista[i].linha1 << "_" << lista[i].linha2 << " trig v(f" << lista[i].difin << ") val = 0.45 rise=1";
			measure << " targ v(p" << lista[i].numarc << ") val = 0.45 rise=1" << endl;
		...
		{
			measure << "\tmeas tran TP_HL_" << lista[i].linha1 << "_" << lista[i].linha2 << " trig v(f" << lista[i].difin << ") val = 0.45 fall=1";
			measure << " targ v(p" << lista[i].numarc << ") val = 0.45 fall=1" << endl;
		...
		{
			measure << "\tmeas tran TP_HL_" << lista[i].linha1 << "_" << lista[i].linha2 << " trig v(f" << lista[i].difin << ") val = 0.45 rise=1";
			measure << " targ v(p" << lista[i].numarc << ") val = 0.45 fall=1" << endl;
			measure << "\techo TP_HL_" << lista[i].linha1 << "_" << lista[i].linha2 << " $&TP_HL_" << lista[i].linha1 << "_" << lista[i].linha2;
			measure << " >> Atrasos.txt" << endl
					<< endl;
		...
		{
			measure << "\tmeas tran TP_LH_" << lista[i].linha1 << "_" << lista[i].linha2 << " trig v(f" << lista[i].difin << ") val = 0.45 fall=1";
			measure << " targ v(p" << lista[i].numarc << ") val = 0.45 rise=1" << endl;
			measure << "\techo TP_LH_" << lista[i].linha1 << "_" << lista[i].linha2 << " $&TP_LH_" << lista[i].linha1 << "_" << lista[i].linha2;
			measure << " >> Atrasos.txt" << endl
					<< endl;
